...
**Master doc:** `docs/FOUL_WARD_MASTER_DOC.md`. **Audit aggregate:** `docs/SUMMARY_VERIFICATION.md`. **Session logs:** 10-file rolling window in `docs/`; full history in `docs/archived/prompts/`. **Source of truth for behaviour:** the repository (code + tests), not deleted REPO_DUMP exports.
