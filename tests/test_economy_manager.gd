...
func test_add_gold_accumulates_across_multiple_calls() -> void:
	...
	assert_int(EconomyManager.get_gold()).is_equal(130)
...
func test_add_gold_emits_gold_resource_type() -> void:
	...
	EconomyManager.add_gold(10)
	assert_int(received_type).is_equal(Types.ResourceType.GOLD)
...
func test_add_gold_emits_correct_new_amount() -> void:
	...
	assert_int(received_amount).is_equal(140)
...
func test_spend_gold_sufficient_deducts_correct_amount() -> void:
	...
	assert_int(EconomyManager.get_gold()).is_equal(40)
...
func test_spend_gold_one_over_balance_returns_false() -> void:
	var result: bool = EconomyManager.spend_gold(101)
	assert_bool(result).is_false()
...
func test_add_building_material_increases_total() -> void:
	...
	assert_int(EconomyManager.get_building_material()).is_equal(15)
...
func test_spend_building_material_sufficient_deducts_amount() -> void:
	...
	assert_int(EconomyManager.get_building_material()).is_equal(7)
...
func test_spend_building_material_insufficient_balance_unchanged() -> void:
	...
	assert_int(EconomyManager.get_building_material()).is_equal(10)

func test_spend_building_material_exact_results_in_zero() -> void:
	EconomyManager.spend_building_material(10)
...
func test_reset_to_defaults_restores_gold_to_100() -> void:
	EconomyManager.add_gold(999)
	EconomyManager.reset_to_defaults()
	assert_int(EconomyManager.get_gold()).is_equal(100)

func test_reset_to_defaults_restores_building_material_to_10() -> void:
...
func test_enemy_killed_signal_awards_gold_reward() -> void:
	...
	assert_int(EconomyManager.get_gold()).is_equal(115)
