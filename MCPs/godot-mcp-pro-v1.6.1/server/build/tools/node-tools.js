...
export function registerNodeTools(server, godot) {
    server.tool("add_node", "Add a new node to the current scene. Supports any Godot node type with optional properties.", {
        type: z.string().describe("Node type (e.g. 'Sprite2D', 'CollisionShape2D', 'Label', 'Camera2D')"),
